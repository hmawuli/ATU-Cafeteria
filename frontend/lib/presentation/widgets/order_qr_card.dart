...
class OrderQrCard extends StatelessWidget {
  ...
  const OrderQrCard(
      {super.key, required this.orderId, required this.pickupCode});
    ...
    return Card(
      child: Padding(
        ...
        child: Column(children: [
          ...
          const SizedBox(height: 8),
          const Text(
              'The vendor should verify the order and pickup code before completing collection.',
