...
class AtuBrand {
  ...
  static Widget title({bool compact = false, Color color = Colors.white}) =>
      Row(
    ...
    return ClipRRect(
      ...
      child: Image.network(
        ...
        errorBuilder: (_, __, ___) => Container(
          ...
          child:
              const Icon(Icons.restaurant, color: AppTheme.primary, size: 34),
        ),
      ),
    );
  }
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: SafeArea(
          ...
          const Padding(
              ...
              child: Text('Good Food • Healthy Minds • Brighter Future',
...
class StepTrack extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    int active = s == 'PREPARING'
        ? 1
        : (s.contains('READY')
            ? 2
            : (s.contains('COMPLE') || s.contains('DELIVER') ? 3 : 0));
                  ...
                  Text(labels[i],
                      ...
                      style: TextStyle(
                          ...
                          color: i <= active
                              ...
                              : AppTheme.textMuted,
                          fontWeight:
                              i == active ? FontWeight.w900 : FontWeight.w500)),
                ]))));
  }
}
