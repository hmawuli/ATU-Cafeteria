...
class ReferenceStudentHomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final foods =
        provider.allFoodItems.where((f) => f.isAvailable).take(8).toList();
    return Scaffold(
              ...
              child: ListView(
                children: [
                  Container(
                    ...
                    child: const Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 6),
                          Text('Great food fuels great minds.',
                              style: TextStyle(
                                  color: Colors.white70, fontSize: 14)),
                        ]),
                  ),
                  const AtuSearchBar(
                      hint: 'Search for food, vendors or meals...'),
                  ...
                  Padding(
                    ...
                    child: Row(children: [
                      Expanded(
                          child: _quick(context, Icons.storefront,
                              'All Vendors', '/student')),
                      const SizedBox(width: 8),
                      Expanded(
                          child: _quick(context, Icons.receipt_long,
                              'My Orders', '/student')),
                      const SizedBox(width: 8),
                      Expanded(
                          child: _quick(
                              context, Icons.shopping_cart, 'Cart', '/cart')),
                      const SizedBox(width: 8),
                      Expanded(
                          child: _quick(
                              context, Icons.settings, 'Settings', '/student')),
                    ]),
                  ),
                        ...
                        child: Row(children: [
                          ...
                          ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                  backgroundColor: AtuUi.gold,
                                  foregroundColor: AtuUi.navy),
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: const [
          ...
          NavigationDestination(
              icon: Icon(Icons.store_outlined), label: 'Vendors'),
          NavigationDestination(
