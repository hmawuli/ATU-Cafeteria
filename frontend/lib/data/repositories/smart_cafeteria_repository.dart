...
class SmartCafeteriaRepository {
  ...
  Future<Map<String, dynamic>> commandCenter() async =>
      _map(await api.request('GET', 'admin/command-center'));
  Future<Map<String, dynamic>> securityAlerts() async =>
      _map(await api.request('GET', 'admin/security-alerts'));
  ...
  Future<Map<String, dynamic>> demandForecast() async =>
      _map(await api.request('GET', 'vendor/demand-forecast'));
  Future<Map<String, dynamic>> wasteSummary() async =>
      _map(await api.request('GET', 'vendor/waste/summary'));
  Future<Map<String, dynamic>> recordWaste(
          ...
          required int wasted,
          String? reason}) async =>
      _map(await api.request('POST', 'vendor/waste', body: {
